...
const products: Product[] = [
  {
    ...
    images: [
      {
        url: image('https://images.pexels.com/photos/33088091/pexels-photo-33088091.jpeg?cs=srgb&dl=pexels-fliqaindia-33088091.jpg&fm=jpg'),
        alt: 'Maroon lehenga front'
      },
      {
        url: image('https://images.pexels.com/photos/20043126/pexels-photo-20043126.jpeg?cs=srgb&dl=pexels-fliqaindia-20043126.jpg&fm=jpg'),
        alt: 'Maroon lehenga detail'
      },
      {
        url: image('https://images.pexels.com/photos/20043153/pexels-photo-20043153.jpeg?cs=srgb&dl=pexels-fliqaindia-20043153.jpg&fm=jpg'),
        alt: 'Maroon lehenga back'
      }
    ],
    isFeatured: true,
    isHotSelling: true,
  ...
  },
  {
    ...
    images: [
      {
        url: image('https://images.pexels.com/photos/20043126/pexels-photo-20043126.jpeg?cs=srgb&dl=pexels-fliqaindia-20043126.jpg&fm=jpg'),
        alt: 'Gold sequin lehenga'
      },
      {
        url: image('https://images.pexels.com/photos/20043153/pexels-photo-20043153.jpeg?cs=srgb&dl=pexels-fliqaindia-20043153.jpg&fm=jpg'),
        alt: 'Gold sequin detail'
      }
    ],
    isFeatured: true,
  ...
  },
  {
    ...
    images: [
      {
        url: image('https://images.pexels.com/photos/28428044/pexels-photo-28428044.jpeg?cs=srgb&dl=pexels-dream_-makkerzz-1603229-28428044.jpg&fm=jpg'),
        alt: 'Ivory saree'
      },
      {
        url: image('https://images.pexels.com/photos/27255671/pexels-photo-27255671.jpeg?cs=srgb&dl=pexels-fotovegraf-312591823-27255671.jpg&fm=jpg'),
        alt: 'Saree close-up'
      }
    ],
    isHotSelling: true,
...
export function getDefaultProductBySlug(slug: string) {
